...
@Component({
  selector: 'app-heatwave-graph',
  templateUrl: './heatwave-graph.component.html',
  styleUrls: ['./heatwave-graph.component.scss'],
})
export class HeatwaveGraphComponent implements OnInit, AfterViewInit {
  @Input() graphData;
