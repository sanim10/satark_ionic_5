...
@Component({
  ...
  templateUrl: './report-accident.page.html',
  styleUrls: ['./report-accident.page.scss'],
})
export class ReportAccidentPage implements OnInit {
  ...
  Submit_form(loc, date, time, msg) {
    var url = 'https://satark.rimes.int/api_road_accident/accident_report_post';
