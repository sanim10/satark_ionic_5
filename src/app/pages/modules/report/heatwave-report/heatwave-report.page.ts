...
@Component({
  selector: 'app-heatwave-report',
  templateUrl: './heatwave-report.page.html',
  styleUrls: ['./heatwave-report.page.scss'],
})
export class HeatwaveReportPage implements OnInit {
  lang;
  img: any;
  today: string;
  now_time: string;
  ...
  Submit_form(feel, loc, issue, heat, date, time, msg) {
    var url = 'https://satark.rimes.int/api_user/heatwave_report_post';
...
// { "year": 2022, "month": 1, "day": 19, "hour": null, "minute": null, "second": null, "millisecond": null, "tzOffset": 0 }
// , "time": { "year": null, "month": null, "day": null, "hour": 2, "minute": 52, "second": null, "millisecond": null, "tzOffset": 0 }
